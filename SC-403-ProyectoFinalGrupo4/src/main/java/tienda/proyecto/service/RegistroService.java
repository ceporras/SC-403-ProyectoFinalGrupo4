...
public class RegistroService {
    ...
    public RegistroService(CorreoService correoService, RolRepository rolRepository, UsuarioService usuarioService, MessageSource messageSource) {
    ...
    public Model recordarUsuario(Model model, Usuario usuario)
        ...
        String mensaje;
        Optional<Usuario> usuarioOpt = usuarioService.getUsuarioPorUsernameOCorreo(usuario.getUsername(), usuario.getEmail());
    ...
    private void enviaCorreoActivar(Usuario usuario, String clave) throws MessagingException {
        ...
        mensaje = String.format(mensaje, usuario.getNombre(), usuario.getPrimerApellido(), servidor, usuario.getUsername(), clave);
    ...
    private void enviaCorreoRecordar(Usuario usuario, String clave) throws MessagingException {
        ...
        mensaje = String.format(mensaje, usuario.getNombre(), usuario.getPrimerApellido(), usuario.getSegundoApellido(), servidor, usuario.getUsername(), clave);
